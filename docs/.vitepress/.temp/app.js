...
const _sfc_main$t = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.34YRgDmG.js"));
...
const PostList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f544ef75"]]);
const RawTheme = {
  extends: theme,
  enhanceApp({ app }) {
