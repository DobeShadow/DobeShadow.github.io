...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"余枫的BLOG","description":"余枫的BLOG - Materials & Chemical Engineering student, Minecraft plugin developer","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"light":"/logo-dark.svg","dark":"/logo-light.svg"},"nav":[{"text":"Home","link":"/"},{"text":"About","link":"/about"},{"text":"Posts","link":"/posts"},{"text":"Projects","link":"/projects"}],"footer":{"message":"Built with VitePress","copyright":"© 2026 DobeShadow"},"search":{"provider":"local"},"outline":{"level":[2,3]}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.BKbHZLqB.js"));
...
const data = JSON.parse(`[{"title":"Hello, World!","date":"2026-08-03T00:00:00.000Z","tags":["Life","Blog"],"excerpt":"","url":"/posts/hello-world"},{"title":"My Journey Building Minecraft Plugins","date":"2026-07-28T00:00:00.000Z","tags":["Minecraft","Java","Development"],"excerpt":"<p>It started with a simple question: <em>&quot;What if the server had a configurable boss that spawns at 8 PM?&quot;</em> That question became <a href=\\"https://github.com/DobeShadow/CustomBoss\\" target=\\"_blank\\" rel=\\"noreferrer\\">CustomBoss</a>.</p>\\n<h2 id=\\"how-i-got-started\\" tabindex=\\"-1\\">How I got started <a class=\\"header-anchor\\" href=\\"#how-i-got-started\\" aria-label=\\"Permalink to &quot;How I got started&quot;\\">&ZeroWidthSpace;</a></h2>\\n<p>I run a survival server called MINEMC, and I kept hitting the same wall: public plugins never did <em>exactly</em> what I wanted. So I learned to write my own. The Bukkit/Paper API is surprisingly approachable once you get past the event system.</p>\\n<h2 id=\\"what-i-ve-built-so-far\\" tabindex=\\"-1\\">What I've built so far <a class=\\"header-anchor\\" href=\\"#what-i-ve-built-so-far\\" aria-label=\\"Permalink to &quot;What I've built so far&quot;\\">&ZeroWidthSpace;</a></h2>\\n<p>| Plugin | What it does |\\n|</p>\\n","url":"/posts/minecraft-plugin-development"},{"title":"Preparing for Graduate School in Materials Science","date":"2026-07-15T00:00:00.000Z","tags":["Academics","Materials"],"excerpt":"","url":"/posts/graduate-school-materials"}]`);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const showTags = ((_a = theme2.value.postList) == null ? void 0 : _a.showTags) ?? true;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "post-list" }, _attrs))} data-v-f544ef75><!--[-->`);
      ssrRenderList(unref(data), (post) => {
        _push(`<article class="post-item" data-v-f544ef75><a${ssrRenderAttr("href", post.url)} class="post-link" data-v-f544ef75><h3 class="post-title" data-v-f544ef75>${ssrInterpolate(post.title)}</h3>`);
        if (post.excerpt) {
          _push(`<p class="post-excerpt" data-v-f544ef75>${ssrInterpolate(post.excerpt)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="post-meta" data-v-f544ef75>`);
        if (post.date) {
          _push(`<time class="post-date" data-v-f544ef75>${ssrInterpolate(post.date)}</time>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(showTags) && post.tags.length) {
          _push(`<span class="post-tags" data-v-f544ef75><!--[-->`);
          ssrRenderList(post.tags, (tag) => {
            _push(`<span class="tag" data-v-f544ef75>#${ssrInterpolate(tag)}</span>`);
          });
          _push(`<!--]--></span>`);
        } else {
          _push(`<!---->`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/PostList.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const PostList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-f544ef75"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "profile-card" }, _attrs))} data-v-c88566f8><img class="avatar"${ssrRenderAttr("src", avatar)} alt="avatar" data-v-c88566f8><h3 class="name" data-v-c88566f8>余枫的BLOG</h3><p class="role" data-v-c88566f8>Materials &amp; Chemical Engineering<br data-v-c88566f8>Minecraft plugin developer</p><p class="bio" data-v-c88566f8> Preparing for graduate school, building Minecraft plugins and running the MINEMC server in my free time. </p><div class="links" data-v-c88566f8><!--[-->`);
      ssrRenderList(links, (l) => {
        _push(`<a${ssrRenderAttr("href", l.url)} target="_blank" rel="noopener" class="link" data-v-c88566f8><span data-v-c88566f8>${ssrInterpolate(l.name)}</span><span class="arrow" data-v-c88566f8>↗</span></a>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/ProfileCard.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ProfileCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c88566f8"]]);
const RawTheme = {
  extends: theme,
  enhanceApp({ app }) {
