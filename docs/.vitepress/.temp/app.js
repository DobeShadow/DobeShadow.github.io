...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.kmflhOnb.js"));
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "profile-card" }, _attrs))} data-v-c2f78724><img class="avatar"${ssrRenderAttr("src", avatar)} alt="avatar" data-v-c2f78724><h3 class="name" data-v-c2f78724>余枫</h3><p class="role" data-v-c2f78724>Materials &amp; Chemical Engineering<br data-v-c2f78724>Minecraft plugin developer</p><p class="bio" data-v-c2f78724> Preparing for graduate school, building Minecraft plugins and running the MINEMC server in my free time. </p><div class="links" data-v-c2f78724><!--[-->`);
      ssrRenderList(links, (l) => {
        _push(`<a${ssrRenderAttr("href", l.url)} target="_blank" rel="noopener" class="link" data-v-c2f78724><span data-v-c2f78724>${ssrInterpolate(l.name)}</span><span class="arrow" data-v-c2f78724>↗</span></a>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
const ProfileCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c2f78724"]]);
const RawTheme = {
  extends: theme,
  enhanceApp({ app }) {
